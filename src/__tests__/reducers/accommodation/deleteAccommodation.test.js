...
describe('Testing Accommodation Reducer', () => {
  it('Accommodation Created LOADING', () => {
    const reducerResult = accommodationReducer(initialState, { type: accommodationActionTypes.DELETE_ACCOMMODATION_START, });
  ...
  it('Accommodation Created Successfully', () => {
    const reducerResult = accommodationReducer(initialState, {
      type: accommodationActionTypes.DELETE_ACCOMMODATION_SUCCESS,
  ...
  it('Accommodation Created Failed', () => {
    const reducerResult = accommodationReducer(initialState, {
      type: accommodationActionTypes.DELETE_ACCOMMODATION_FAILURE,
  ...
  it('Accommodation Created End', () => {
    const reducerResult = accommodationReducer(initialState, { type: accommodationActionTypes.DELETE_ACCOMMODATION_END, });
    expect(reducerResult.accommodation).toHaveProperty('loading');
  });
  it('default', () => {
    const reducerResult = accommodationReducer(initialState, {
