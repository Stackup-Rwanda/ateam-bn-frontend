...
describe('ForgotPassword Component', () => {
  beforeEach(() => {
    ...
    form = component.find('form[title="Find your Barefoot account"]');
    inputs = component.find('form[title="Find your Barefoot account"] input');
    button = component.find('form[title="Find your Barefoot account"] button[type="submit"]');
